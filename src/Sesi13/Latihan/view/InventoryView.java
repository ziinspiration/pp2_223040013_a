package Sesi13.Latihan.view;

import Sesi13.Latihan.controller.InventoryController;
import Sesi13.Latihan.model.Inventory;
    ...
    private void loadInventoryData() {
        SwingWorker<List<Inventory>, Void> worker = new SwingWorker<List<Inventory>, Void>() {
            ...
            protected List<Inventory> doInBackground() {
                return controller.getAllInventories(); // Memanggil metode yang benar di controller
            }
