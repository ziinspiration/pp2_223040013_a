package StudiKasus5.view;

import StudiKasus5.controller.InventoryController;
import StudiKasus5.model.Inventory;
import javax.swing.*;
...
public class InventoryView {
    ...
    private void loadInventoryData() {
        ...
        JFrame progressFrame = new JFrame("Memuat Data...");
        progressFrame.setSize(300, 100);
        progressFrame.add(panel);
        progressFrame.setVisible(true);

        SwingWorker<List<Inventory>, Integer> worker = new SwingWorker<>() {
            @Override
